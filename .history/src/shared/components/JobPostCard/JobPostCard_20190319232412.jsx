    ...
    <div className="jobcardWrapper">
      ...
      <div style={styles.rowInfo}>
        <span style={styles.miniInfoText}>
          <i style={styles.icon} class="fa fa-map-marker" />
          Cebu City
        </span>

        <span style={styles.miniInfoText}>
          <i style={styles.icon} class="fa fa-briefcase" />1 - 3 years
        </span>
      </div>

      <div style={styles.rowInfo}>
        <span style={styles.miniInfoText}>
          <i style={styles.icon} class="fa fa-graduation-cap" />
          Diploma
        </span>

        <span style={styles.miniInfoText}>
          <i style={styles.icon} class="fa fa-clock" />
          Full Time
        </span>
      </div>
